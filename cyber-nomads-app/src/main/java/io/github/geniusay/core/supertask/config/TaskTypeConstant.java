...
public class TaskTypeConstant {
    ...
    public static final String INFINITY_HOT_VIDEO_SUMMARY = "infinity:hot:video:Summary:";  // 无限评论热门视频
    public static final String INFINITY_HOT_COMMENT_REPLY = "infinity:hot:comment:reply:";  // 无限回复热门评论
    ...
    public static final String SINGLE_VIDEO_CUSTOM_COMMENT = "single_video_custom_comment";  // 单一视频定制评论
}